...
class Goto_IC_Stmt: public Icode_Stmt
{
	int lineno;
public:
	Goto_IC_Stmt(Tgt_Op inst_op, int );

	Goto_IC_Stmt & operator=(const Goto_IC_Stmt & rhs);
...
class Relational_IC_Stmt: public Icode_Stmt
{
	Ics_Opd * opd1;
	Ics_Opd * opd2;
	Ics_Opd * result;
...
public:
	Branch_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1, Ics_Opd * opd2, int line); 
	~Branch_IC_Stmt();
