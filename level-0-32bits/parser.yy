...
|
	variable comparision_op constant
	{
		$$ = new Relational_Ast($1, $3, $2);
	}
|
	constant comparision_op variable
	{
		$$ = new Relational_Ast($1, $3, $2);
	}
|
	variable comparision_op variable
	{
		$$ = new Relational_Ast($1, $3, $2);
	}
|
	constant comparision_op constant
	{
		$$ = new Relational_Ast($1, $3, $2);
	}
;
